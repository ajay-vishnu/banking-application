...
const Dashboard = ({ Withdraw, Transfer, Deposit, UserDetails, Logout }) => {
  ...
  const [transferDetails, setTransferDetails] = useState({userAccount: "", creditAmount: "", message: "", debitAmount: ""});
    ...
    <div>
      ...
      <div className="banking__dashboard-transactions">
        <div className="banking__dashboard-transactions_deposit">
          ...
          <input type="text" name="deposit_message" id="deposit_message" onChange={e => setTransferDetails({...transferDetails, message: e.target.value})} value={transferDetails.message}/>
          <button onClick={() => Deposit(transferDetails)}>Deposit</button>
        </div>
        <div className="banking__dashboard-transactions_withdraw">
          Withdraw
          <input type="number" name="withdraw_amount" id="withdraw_input" />
          <input type="text" name="withdraw_message" id="withdraw_message" />
          <button onClick={() => Deposit(transferDetails)}>Withdraw</button>
        </div>
